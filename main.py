...
def show_intro():
    ...
    print("This is a beta version of 'Auto Minecraft Server Setup' and is still under development, please report any bugs to the developer.")
